...
namespace RV2R_RutsStuff
{
    public class JobGiver_Wildlife_ProposeVore : ThinkNode_JobGiver
    {
        ...
        {
            if (target.IsWildAnimal()) return true;
            if (!animal.RaceProps.predator) return RV2_Rut_Settings.rutsStuff.WildToColonistPrey;
        ...
        {
            if (!animal.RaceProps.predator) return VoreRole.Prey;
